...
if [[ "$1" == "--dry" ]]; then
    ...
    if [ $# -eq 0 ]; then
        ...
        case $SUBJECT in
            "DaCapo")
                JAR_FILE="$SUBJECTS_DIR/dacapo-1.jar"
                case $WORKLOAD in
...
SUBJECTS_DIR="/home/avaneesh/Green-Lab-Course-Work-Group-5/Assignment_3/baseline/Subjects"
RESULTS_DIR="/home/avaneesh/Green-Lab-Course-Work-Group-5/Assignment_3/baseline/results/run_${RUN_NUM}"
HEAP_MIN="3G"
HEAP_MAX="3G"
TEMP_THRESHOLD=58
BASELINE_TEMP=48
